...
public class Team4 extends Activity {

    String[] player={"Kane Williamson","Ross Taylor","Tom Latham","Colin de Grandhomme", "Lockie Ferguson","Trent Boult","Martin Guptill"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putStringArrayListExtra("newzeland",newzeland);
